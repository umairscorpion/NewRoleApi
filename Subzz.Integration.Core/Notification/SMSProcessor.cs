	...
	public class SMSProcessor: ISMSProcessor
	{
		...
		public void Process(Message message, MailTemplateEnums mailTemplateEnums)
		{
            ...
            Dictionary<string, string> param = new Dictionary<string, string>()
            {
                ...
                ["{Date}"] = message.DateToDisplayInSMS ?? "",
            ...
            {
                CommunicationContainer.MessagingClient.SendMessage(message.FromPhoneNumber.Trim(), message.PhoneNumber, body, message.AbsenceId);
            }
            else
            {
